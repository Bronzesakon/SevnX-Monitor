...
<template>
  ...
  >
    <template v-if="name === 'refresh'">
      <path d="M20 11a8.1 8.1 0 0 0-14.3-4.9L3 9" />
      <path d="M3 4v5h5" />
      <path d="M4 13a8.1 8.1 0 0 0 14.3 4.9L21 15" />
      <path d="M21 20v-5h-5" />
    </template>
    ...
    <template v-else-if="name === 'back'">
      <path d="m14.8 5.5-6.5 6.5 6.5 6.5" />
    </template>
    ...
    <template v-else-if="name === 'external'">
      <path d="M14 4h6v6M11 13 20 4M20 14v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h4" />
    </template>
